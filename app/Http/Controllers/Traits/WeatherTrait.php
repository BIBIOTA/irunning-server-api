...
trait WeatherTrait
{
    public function getHttpWeatherData(string $cityId, string $district)
    {
    ...
    public function getColumnsKey(string $elementName): bool
    {
    ...
    public function getValue(string $elementName, array $elementValue): string
    {
        $result;
        switch ($elementName) {
            case 'T':
